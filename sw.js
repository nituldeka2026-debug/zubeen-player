const CACHE_V9='zubeen-radio-v11-stable';
const APP=['/','/index.html','/style.css','/app.js','/schedule.html','/manifest.webmanifest','/icon.svg','/assets/zubeen-bg.jpg','/assets/zubeen-bg-wide.jpg'];
